...
export default function App() {
  ...
  function handleNotificationClick() {
    ...
    if (Notification.permission === "default") {
      ...
      showCustomNotification(`New Member`, {
        body: `New Member joined to group!`,
        icon: "https://deploy-by-me.netlify.app/image/favicon/favicon-32x32.png",
      });
    }
  ...
  useEffect(() => {
    ...
    socket.current.on("connect", () => {
      socket.current.on("roomNotice", (userName) => {
        ...
        showCustomNotification(`New Message`, {
          body: `${userName} joined to group!`,
          icon: "https://deploy-by-me.netlify.app/image/favicon/favicon-32x32.png",
        });
      });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-100 font-inter">
      {/* ENTER YOUR NAME TO START CHATTING */}
      {showNamePopup && (
        <div className={`fixed inset-0 flex items-center justify-center z-40 m-2`}>
          <div className="bg-white rounded-xl shadow-lg max-w-md p-6">
            ...
            <form onSubmit={handleNameSubmit} className="mt-4">
              <input
                ...
                placeholder="Your name (e.g. Mansi)"
              />
              <button
                type="submit"
      ...
      {/* CHAT WINDOW */}
      {!showNamePopup && (
        <div className="w-full max-w-2xl h-[100vh] bg-white shadow-md flex flex-col overflow-hidden">
          {/* CHAT HEADER */}
